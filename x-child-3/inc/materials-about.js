        ...
        for (let mat in materialsData[tech]) {
          ...
          <label>
            <div class="input-container">
                <input class="input-tab input-onclick" data-controls="stl_material_" data-text="${mat}" type="image" value=${matLowercase} src="http://forgelabs.ca/wp-content/themes/x-child-3/assets/${matLowercase}.png">
            </div>
        ...
        if (tech === selectedTech) {
          ...
          for (mat in materialsData[tech]) {
            if (mat === selectedMat) {
              ...
              $('.about-img > img').attr('src', `http://forgelabs.ca/wp-content/themes/x-child-3/assets/${matLowercase}.png`);
